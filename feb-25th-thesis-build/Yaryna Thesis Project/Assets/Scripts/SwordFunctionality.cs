...
public class SwordFunctionality : MonoBehaviour
{
    ...
    public string fullText = "Press the E key to take the sword.";
...
//
        ...
        if ((Input.GetKeyDown(KeyCode.A) || Input.GetKeyDown(KeyCode.D)) && textComplete) //YES/NO FUNCTIONALITY
        {
...
//
        ...
        //    textComplete = false;
        //}
        if (Input.GetKeyDown(KeyCode.E) && textComplete && !hasSword) {
            NPCDialogueParent.SetActive(false);
            isInDialogue = false;
            //Time.timeScale = 1f;
            textComplete = false;
